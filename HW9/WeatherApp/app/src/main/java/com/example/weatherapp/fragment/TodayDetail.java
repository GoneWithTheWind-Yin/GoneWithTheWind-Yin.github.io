...
public class TodayDetail extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            ...
            Precipitation.setText(String.format("%.2f", currentDayData.getDouble("precipitationProbability")) + "%");
            ...
            ozone.setText(String.format("%.2f", currentDayData.getDouble("uvIndex")));
