...
public class SummaryDetail extends Fragment {
    ...
    private String renderIconsString = "function renderIcons() {" +
            ...
            ".add(this.series[2].group);}this.series[0].icon." +
            "translate(this.chartWidth / 2 - 10,this.plotHeight / 2 - this.series[0].points[0]." +
            "shapeArgs.innerR -(this.series[0].points[0].shapeArgs.r - this.series[0].points[0].shapeArgs.innerR) / 2);" +
            " if(!this.series[1].icon) {this.series[1].icon = " +
            "this.renderer.path(['M', -8, 0, 'L', 8, 0, 'M', 0, -8, 'L', 8, 0, 0, 8,'M', 8, -8, 'L', 16, 0, 8, 8])" +
            ".attr({'stroke': '#ffffff','stroke-linecap': 'round','stroke-linejoin': 'round','stroke-width': 2,'zIndex': 10})" +
            ".add(this.series[2].group);}this.series[1].icon.translate(this.chartWidth / 2 - 10,this.plotHeight / 2 - this.series[1]" +
            ".points[0].shapeArgs.innerR -(this.series[1].points[0].shapeArgs.r - this.series[1].points[0].shapeArgs.innerR) / 2); " +
            "if(!this.series[2].icon) {this.series[2].icon = this.renderer.path(['M', 0, 8, 'L', 0, -8, 'M', -8, 0, 'L', 0, -8, 8, 0])." +
            "attr({'stroke': '#303030','stroke-linecap': 'round','stroke-linejoin': 'round','stroke-width': 2,'zIndex': 10})." +
            "add(this.series[2].group);}this.series[2].icon.translate(this.chartWidth / 2 - 10,this" +
            ".plotHeight / 2 - this.series[2].points[0].shapeArgs.innerR -(this.series[2].points[0].shapeArgs.r " +
            "- this.series[2].points[0].shapeArgs.innerR) / 2);}";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(
                R.layout.fragment_summary_detail, container, false);
        try {
            ...
            HIChartView chartView = (HIChartView) rootView.findViewById(R.id.summary_chart);
            ...
            paneBackground1.setBackgroundColor(HIColor.initWithRGBA(122, 200, 60, 0.35));
            ...
            paneBackground2.setBackgroundColor(HIColor.initWithRGBA(111, 178, 250, 0.35));
            ...
            paneBackground3.setBackgroundColor(HIColor.initWithRGBA(244, 113, 106, 0.35));
            ...
            data1.setColor(HIColor.initWithRGB(122, 200, 60));
            data1.setRadius("112%");
            data1.setInnerRadius("88%");
            data1.setY(currentDayData.getInt("cloudCover"));
            ...
            data2.setColor(HIColor.initWithRGB(111, 178, 250));
            data2.setRadius("87%");
            data2.setInnerRadius("63%");
            data2.setY(currentDayData.getInt("precipitationProbability"));
            ...
            data3.setColor(HIColor.initWithRGB(244, 113, 106));
            data3.setRadius("62%");
            data3.setInnerRadius("38%");
            data3.setY(currentDayData.getInt("humidity"));
